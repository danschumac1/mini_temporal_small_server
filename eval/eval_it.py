...
def main():
    ...
    # get rid of html tokens
    pred_df['PREDICTION'] = pred_df['PREDICTION'].apply(lambda text: ' '.join(re.findall(r'\w+', text.lower()))[:15])
    # for pred in  pred_df['PREDICTION']:
    #     print(pred)
    # return
    ...
    pred_df['QUESTION'] = pred_df['QUESTION'].apply(lambda x: x.split(' Here is the context:')[0])
